...
def main(_):
  ...
  with tf.name_scope('adam_optimizer'):
    train_step = tf.train.GradientDescentOptimizer(0.01).minimize(cross_entropy)#accuracy 0.97
  ...
  with tf.Session() as sess:
    ...
    for i in range(10000):
      batch = swallowsound.train.next_batch(1000)#batch 200 比 50的效果好  # batch(500) test accuracy 0.985714
      if i % 500 == 0:
...
if __name__ == '__main__':
  ...
  parser.add_argument('--data_dir', type=str,
                      default='/data/tmp/tensorflow/noise/input_data0',
