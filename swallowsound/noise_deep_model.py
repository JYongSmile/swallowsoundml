...
dir = '/data/tmp/tensorflow/noise/input_data'
...
for i in range(20000):
    batch = swallowsound.train.next_batch(1500)
...
# print('测试开始...')
# sess = tf.Session()
# saver.restore(sess,"3_cnn/model.ckpt")
#
# print('测试精度为： %g' % accuracy.eval(session=sess, feed_dict={x: swallowsound.test.images, y_: swallowsound.test.labels,
#                                                            keep_prob: 0.5}))
# print('测试结束！')
...
#tensorboard  --logdir=C:\Users\jiangyong\PycharmProjects\swallowsoundml\swallowsound\logs\